# Frontmatter
- Log file: `reports/maze_shaping_pbrs_manhattan_v2/experiment_log.md`
- Script: `experiments/maze_shaping_icml_style/run_maze_shaping_experiment.py`
- Output roots:
  - `outputs/maze_shaping_icml_style_pbrs_manhattan_v2`

# Goal
- gamma=0.99, step=0, goal=1 설정의 Manhattan PBRS 검증.
